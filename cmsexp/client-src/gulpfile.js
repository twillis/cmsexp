...
var CKEDITOR_LIB = [
    'bower_components/ng-ckeditor/libs/ckeditor/**/*'
];
...
gulp.task('ckeditor', function(){
    return gulp.src(CKEDITOR_LIB)
    .pipe(gulp.dest('../static/scripts/ckeditor/'));
});

// coffee-script
gulp.task('scripts', ['vendor', 'ckeditor'], function(){
